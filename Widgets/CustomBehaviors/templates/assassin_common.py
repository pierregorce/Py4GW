...
class AssassinCommon(CustomBehaviorBaseUtility):
    ...
    def __init__(self, cached_data: CacheData):
        ...
        # todo skills must be overrible, and we can do limit_mana_xxx and just override ?
        #like dash is nothing smart, so we can have generic
        #like any buff we need to keep up in aggro / close to aggro
