...
from Widgets.CustomBehaviors.templates.RangerTao_UtilitySkills.needling_shot_utility import NeedlingShotUtility
from Widgets.CustomBehaviors.templates.RangerTao_UtilitySkills.scavenger_strike_utility import ScavengerStrikeUtility
...
class RangerTaoBowSpam(CustomBehaviorBaseUtility):
    ...
    def __init__(self, cached_data: CacheData):
        ...
        self.never_rampage_alone_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(skill=CustomSkill("Never_Rampage_Alone"), current_build=in_game_build, score_definition=ScoreStaticDefinition(81))
        self.expert_focus_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(skill=CustomSkill("Expert_Focus"), current_build=in_game_build, score_definition=ScoreStaticDefinition(80))

        self.needling_shot_utility: CustomSkillUtilityBase = NeedlingShotUtility(skill=CustomSkill("Needling_Shot"), current_build=in_game_build, score_definition=ScoreStaticDefinition(90))
        ...
        # self.scavenger_strike_utility: CustomSkillUtilityBase = ScavengerStrikeUtility(skill=CustomSkill("Scavenger_Strike"), current_build=in_game_build, additive_score_weight=0)
        # self.comfort_animal_utility: CustomSkillUtilityBase = GenericUtility(skill=CustomSkill("Comfort_Animal"), current_build=in_game_build, additive_score_weight=0)
    ...
    def skills_allowed_in_behavior(self) -> list[CustomSkillUtilityBase]:
        return [
            ...
            self.expert_focus_utility,
            self.sundering_attack_utility,
            self.needling_shot_utility,
    ...
    def skills_required_in_behavior(self) -> list[CustomSkill]:
        return [
            ...
            # self.expert_focus_utility.custom_skill,
            # self.sundering_attack_utility.custom_skill,
            # self.needling_shot_utility.custom_skill,
        ]