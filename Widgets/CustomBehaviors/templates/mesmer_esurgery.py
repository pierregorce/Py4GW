...
class MesmerESurgery(CustomBehaviorBaseUtility):
    ...
    def __init__(self, cached_data: CacheData):
        ...
        self.ebon_battle_standard_of_wisdom: CustomSkillUtilityBase = EbonBattleStandardOfWisdom(skill=CustomSkill("Ebon_Battle_Standard_of_Wisdom"),score_definition= ScorePerAgentQuantityDefinition(lambda enemy_qte: 99 if enemy_qte >= 3 else 99 if enemy_qte <= 2 else 99), current_build=in_game_build, mana_required_to_cast=18)
