...
class LifeBondUtility(CustomSkillUtilityBase):
    def __init__(self,
        ...
        score_definition: ScoreBoostedOnSelfDefinition = ScoreBoostedOnSelfDefinition(20, 79),
        ...
        self.score_definition: ScoreBoostedOnSelfDefinition = score_definition

        self.add_plugin_precondition(lambda x: ShouldWaitForHeroicRefrain(x.custom_skill, should_wait_for_heroic_refrain))
        self.add_plugin_watchdog(lambda x: ShouldLockUntilBuffCompletion(x.custom_skill, is_buff_config_fulfilled= lambda: self._get_target_id() is None, default_value= True))
    ...
    def _get_target_id(self) -> int | None:
    ...
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        ...
        return self.score_definition.get_score(target_id)
