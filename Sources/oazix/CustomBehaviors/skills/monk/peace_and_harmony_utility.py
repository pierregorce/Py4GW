...
class PeaceAndHarmonyUtility(CustomSkillUtilityBase):
    ...
    def _get_targets(self) -> list[TargetingAllyData]:
        ...
        targets: list[TargetingAllyData] = TargetingAlly.create().get_allies(
            ...
            condition_predicate=lambda ally_data: Agent.IsHexed(ally_data.agent_id) or Agent.IsConditioned(ally_data.agent_id),
            sort_asc_predicate=lambda ally_data: (-ally_data.hex_priority_score, -ally_data.condition_priority_score))
        return targets
