...
from Py4GWCoreLib import Range, Player, Agent
...
class VigorousSpiritUtility(CustomSkillUtilityBase):
    def __init__(
        self,
        event_bus: EventBus,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Vigorous_Spirit"),
    ...
    def _get_target(self) -> int | None:
        targets = TargetingAlly.create().get_allies(
            ...
            sort_asc_predicate=lambda ally_data: (1 if Agent.IsMelee(ally_data.agent_id) else 0, ally_data.distance_from_player),
        )
