...
class MindWrackUtility(CustomSkillUtilityBase):
    def __init__(self,
        event_bus: EventBus,
    ...
    def _execute(self, state: BehaviorState) -> Generator[Any, None, BehaviorResult]:
        ...
        return (yield from custom_behavior_helpers.Actions.cast_skill_to_target_with_lock(self._get_lock_key(target.agent_id), self.custom_skill, target_agent_id=target.agent_id))
