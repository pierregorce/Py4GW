...
class ScytheRequiringEnchantmentUtility(CustomSkillUtilityBase):
    def __init__(self,
    event_bus: EventBus,
    skill: CustomSkill,
    ...
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        ...
        has_dervish_enchantment = custom_behavior_helpers.Resources.has_dervish_enchantment()
        if not has_dervish_enchantment: return None
    ...
    def customized_debug_ui(self, current_state):
        PyImGui.bullet_text(f"has_dervish_enchantment : {custom_behavior_helpers.Resources.has_dervish_enchantment()}")