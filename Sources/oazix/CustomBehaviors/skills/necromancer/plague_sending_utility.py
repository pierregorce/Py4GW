...
class PlagueSendingUtility(CustomSkillUtilityBase):
    ...
    def _get_cultists_fervor_best_targets(self) -> list[TargetingEnemyData]:
        return TargetingEnemy.create().get_enemies(
            within_range=Range.Spellcast.value,
            condition_predicate=lambda enemy_data: not Agent.IsBleeding(enemy_data.agent_id) and not Agent.IsSpirit(enemy_data.agent_id),
