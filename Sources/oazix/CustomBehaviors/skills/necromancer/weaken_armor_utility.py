...
class WeakenArmorUtility(CustomSkillUtilityBase):
    ...
    def __init__(
        ...
        score_definition: ScorePerAgentQuantityDefinition = ScorePerAgentQuantityDefinition(
            lambda enemy_qte: 65 if enemy_qte >= 3 else 45 if enemy_qte >= 2 else 20
        ),
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Weaken_Armor"),
    ...
    def _get_lock_key(self, agent_id: int) -> str:
        return f"WeakenArmor_{agent_id}"
