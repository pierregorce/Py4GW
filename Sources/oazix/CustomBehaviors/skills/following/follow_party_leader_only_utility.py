...
from Sources.oazix.CustomBehaviors.primitives.scores.score_per_status_definition import ScorePerStatusDefinition
...
class FollowPartyLeaderOnlyUtility(CustomSkillUtilityBase):
    ...
    def _get_party_leader_position(self) -> tuple[float, float] | None:
        ...
        try:
            ...
            self.logger.information(f"FollowPartyLeaderOnlyUtility._get_party_leader_position error: {e}")
            return None
    ...
    def _execute(self, state: BehaviorState) -> Generator[Any, None, BehaviorResult]:
        ...
        try:
            ...
            self.logger.information(f"FollowPartyLeaderOnlyUtility._execute error: {e}")
            yield
            return BehaviorResult.ACTION_SKIPPED
    ...
    def draw_overlay(self, current_state: BehaviorState) -> None:
        ...
        try:
            ...
            self.logger.information(f"FollowPartyLeaderOnlyUtility.draw_overlay error: {e}")
